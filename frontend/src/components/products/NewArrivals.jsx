  ...
  return (
    <section className="relative py-10 px-4 lg:px-0">
      <div className="container mx-auto text-center mb-10">
        <h2 className="text-2xl font-bold mb-4 capitalize">Explore New Arrivals</h2>
      ...
      >
        {cars.length > 0 ? (
            ...
            return (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-40 backdrop-blur-md text-white p-4">
                  <h4 className="font-semibold text-lg truncate">{car.name || "Unknown Car"}</h4>
                  ...
                  <div className="mt-2 text-xs flex flex-wrap justify-between gap-1">
                    <span className="flex items-center gap-1">
                      <FiMapPin className="text-gray-300" /> {car.location || "Unknown"}
                    </span>
                    <span className="flex items-center gap-1">
                      <FaGasPump className="text-gray-300" /> {car.fuelType || "N/A"}
                    </span>
                    <span className="flex items-center gap-1">
                      <FaCogs className="text-gray-300" /> {car.transmission || "N/A"}
                    </span>
                    <span className="flex items-center gap-1">
                      <FaCalendarAlt className="text-gray-300" /> {car.year || "N/A"}
                    </span>
                  </div>
                </div>
              </div>
          ...
          <p className="text-center text-gray-500 w-full">No new arrivals yet.</p>
        )}
      </div>
    </section>
  );
